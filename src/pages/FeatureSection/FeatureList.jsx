...
const FeatureList = () => {
  return (
    <div className="bg-gradient-to-b from-brand-gray to-brand-gray/5 to-90% flex justify-center py-8">
      <div className="flex flex-col items-center w-full max-w-6xl">
        ...
        <div className="flex font-manrope max-w-5xl text-sm md:text-base p-6">
